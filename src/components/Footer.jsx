...
export function Footer() {
  return (
    <footer className="flex w-full flex-col items-center justify-center gap-4 bg-DarkBlue py-12 text-center text-base md:justify-start md:gap-10 md:px-14 lg:flex-row lg:justify-between lg:px-20 lg:text-left xl:px-36 [&_li]:text-white">
      <div className="mb-4 flex flex-col gap-8 md:mb-0">
      ...
      <div className="mt-6 md:mx-auto lg:mx-0">
        <button className="mb-4 px-6 lg:ml-auto lg:block">
          Request Invite
        </button>
